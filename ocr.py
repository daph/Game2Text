...
def detect_and_log(engine, cropped_image,  text_orientation, session_start_time, request_time, audio_recorder, mocr):
    result = image_to_text(engine, cropped_image, text_orientation, mocr)
...
def image_to_text(engine, base64img, text_orientation, mocr):
